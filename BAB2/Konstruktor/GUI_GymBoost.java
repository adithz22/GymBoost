...
public class GUI_GymBoost extends javax.swing.JFrame {
    ...
    public GUI_GymBoost(String nama, int usia, String program, int durasi) {
        initComponents();  // tetap panggil initComponents untuk inisialisasi GUI

        // Isi field teks langsung dengan data dari parameter
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
        public void run() {
            // Pakai constructor dengan parameter untuk isi default form
            new GUI_GymBoost("Aditya Surya Pratama", 25, "Strength Training", 60).setVisible(true);
        }
    });
}
